...
public class MenuBar extends JFrame{
   ...
   void createMenu() {
      ...
      JMenuItem[] mListItem1 = new JMenuItem[2];  // 메뉴별 내용 배열로
      JMenuItem[] mListItem2 = new JMenuItem[1];
      JMenuItem[] mListItem3 = new JMenuItem[2];
      JMenuItem[] mListItem4 = new JMenuItem[1];

      mListItem1[0] = new JMenuItem("Home");
      mListItem1[0].setName("Home");
      mListItem1[1] = new JMenuItem("Exit");
      mListItem1[1].setName("Exit");
...
//      mListItem4[1] = new JMenuItem("순위");
//      mListItem4[1].setName("순위");
   ...
   class myActionListener implements ActionListener{  // 메뉴바에서 메뉴를 고를때 액션
      ...
      public void actionPerformed(ActionEvent e) {
         ...
         if(m.getName().equals("그래프"))
         {
            ...
            /////////////	그래프 그릴 때 True로 초기화	///////////////
            jp5.isFirstBoot = true;
            ///////////////////////////
            jp5.setBackground(new Color(50, 133, 187));
            JFrame mNewJFrame_Graph =  new JFrame();
            mNewJFrame_Graph.getContentPane().removeAll();
            mNewJFrame_Graph.getContentPane().add(jp5);
			mNewJFrame_Graph.setLocation(1180, 0);
			mNewJFrame_Graph.setSize(750, 600);
			mNewJFrame_Graph.setVisible(true);
         }
