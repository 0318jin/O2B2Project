...
//	Select_Profile mSp = new Select_Profile();
	...
	//	실제 학습시간
	ArrayList<Float> mListGraph = new ArrayList<Float>();
	
	public void setGraph(ArrayList<Float> graph) {
	...
	//	스케쥴 학습시간
	ArrayList<Float> mListGraph_Schedule = new ArrayList<Float>();
	
	public void setGraph_S(ArrayList<Float> graph) {
		///	그래프를 여러번 그리면 arraylist값이 계속 추가되므로 지워주는 부분
