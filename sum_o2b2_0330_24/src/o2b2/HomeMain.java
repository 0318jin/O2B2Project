...
import java.awt.TextField;      //헤더 선언
import javax.swing.*;
...
//    private JTextField jtextfield1;
    ...
    public homemain(JPanelTest win){
       ...
       add(imagelJLabel3);
        ...
        //////////////////////////////////////////////
        JPasswordField jtextfield1 = new JPasswordField(10);
        ...
        jButton1.addActionListener(new ActionListener() {
            ...
            if(jtextfield1.getText().equals("1234")) {  // 비밀번호 입력 값
               ...
               MenuBar.mFrame.getContentPane().removeAll();
               MenuBar.mFrame.getContentPane().add(jp3);
               MenuBar.mFrame.revalidate();
               MenuBar.mFrame.repaint();
            }
            else {
